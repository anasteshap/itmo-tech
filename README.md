# Лабораторные работы по дисциплине "Технологии программирования на Java"

# [Lab-1](https://github.com/anasteshap/itmo-tech/tree/lab-1)
...
Фреймворк для тестирования - [JUnit](https://mvnrepository.com/artifact/org.junit.jupiter/junit-jupiter-api).

Система сборки: Maven.


# [Lab-2](https://github.com/anasteshap/itmo-tech/tree/lab-2)
...
# [Lab-3](https://github.com/anasteshap/itmo-tech/tree/lab-3)
...
Необходимо показать работоспособность endpoint’ов через HTTP запросы (рекомендуется [Postman](https://www.postman.com/downloads/)).

# [Lab-4](https://github.com/anasteshap/itmo-tech/tree/lab-4)
